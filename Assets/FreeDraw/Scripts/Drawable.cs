...
// BRUSH TYPES. Implement your own here
        ...
        // This is the version I made when using the world space quad
        ...
        public void MarkPixelsToColour(Vector2 center_pixel, int pen_thickness, Color color_of_pen)
        {
            ...
            for (int x = center_x - pen_thickness; x <= center_x + pen_thickness; x++)
            {
                ...
                //if (x >= (int)drawable_sprite.rectTransform.rect.width || x < 0)
                //    continue;
                if (x >= pixelWidth || x < 0)
                    continue;
        ...
        public void MarkPixelToChange(int x, int y, Color color)
        {
            ...
            //int array_pos = y * (int)drawable_sprite.rectTransform.rect.width + x;
            int array_pos = y * pixelWidth + x;
            //print(array_pos);
        ...
        //    float pixelWidth = drawable_sprite.rectTransform.rect.width;
        //    float pixelHeight = drawable_sprite.rectTransform.rect.height;
        //    float unitsToPixels = pixelWidth / drawable_sprite.bounds.size.x * transform.localScale.x;

        //    // Need to center our coordinates
        //    float centered_x = local_pos.x * unitsToPixels + pixelWidth / 2;
        //    float centered_y = local_pos.y * unitsToPixels + pixelHeight / 2;
        //    //print("X: " + centered_x.ToString("F0"));
        //    //print("Y: " + centered_x.ToString("F0"));
        ...
        void Awake()
        {
            ...
            //drawable_sprite = this.GetComponent<Image>();
            //drawable_texture = drawable_sprite.mainTexture;

            // Initialize clean pixels to use
            clean_colours_array = new Color[(int)drawable_sprite.rectTransform.rect.width * (int)drawable_sprite.rectTransform.rect.height];
